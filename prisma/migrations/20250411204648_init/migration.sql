...
CREATE TABLE "Pokedex" (
    ...
    CONSTRAINT "Pokedex_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Owned_userId_name_key" ON "Owned"("userId", "name");
